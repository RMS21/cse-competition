...
<html lang="en">
    ...
    <body>
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group label-floating has-error">
                                                ...
                                                <input type="password" class="form-control" placeholder="شماره دانشجویی">
                                                <span class="material-icons form-control-feedback">clear</span>
                                                <span class="material-input"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group label-floating has-error">
                                                ...
                                                <input type="password" class="form-control" placeholder="سال ورود">
                                                <span class="material-icons form-control-feedback">clear</span>
                                                <span class="material-input"></span>
                                            </div>
                                        </div>
        ...
        <script src="E:\web\bootstrap-3.3.7-dist\jquery-3.1.1.min.js"></script>
        <script src="E:\web\bootstrap-3.3.7-dist\js\bootstrap.js"></script>
